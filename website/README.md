...
wrangler r2 object put weflow-releases/releases/5.0.5/WeFlow-5.0.5-Setup.dmg \
  --remote \
  --file=release/WeFlow-5.0.5-Setup.dmg \
  --content-type=application/x-apple-diskimage \
  --content-disposition='attachment; filename="WeFlow-5.0.5-Setup.dmg"' \
